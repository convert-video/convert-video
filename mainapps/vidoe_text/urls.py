...
urlpatterns=[
    ...
    path('process-background-music/<str:textfile_id>/', process_background_music, name='process_background_music'),
    path('media/<str:file_name>/', serve_file, name='serve_file'),
    ...
    path('api/process-background-music/<int:textfile_id>/', process_background_music_api, name='process_background_music_api'),
